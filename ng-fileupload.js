            ...
            if (val !== undefined) {
                ...
                if (angular.isString(val)) {
                    ...
                    if (angular.isObject(val)) {
                        if (val.$$ngfCircularDetection) throw 'ngFileUpload: Circular reference in config.data. Make sure specified data forimageUpload.upload() has no circular reference: ' + key;
...
ngFileUpload.service('imageUpload', ['$parse', '$timeout', '$compile', '$q', 'UploadExif', function ($parse, $timeout, $compile, $q, UploadExif) {
...
ngFileUpload.directive('ngfSelect', ['$parse', '$timeout', '$compile','imageUpload', function ($parse, $timeout, $compile, Upload) {
    var generatedElems = [];
    ...
    function isDelayedClickSupported(ua) {
        ...
        if (m && m.length > 2) {
            var v =imageUpload.defaults.androidFixMinorVersion || 4;
...
(function () {
    ...
    function linkFileDirective(Upload, $timeout, scope, elem, attr, directiveName, resizeParams, isBackground) {
        function constructDataUrl(file) {
            var disallowObjectUrl =imageUpload.attrGetter('ngfNoObjectUrl', attr, scope);
           imageUpload.dataUrl(file, disallowObjectUrl)['finally'](function () {
                $timeout(function () {
        ...
        $timeout(function () {
            var unwatch = scope.$watch(attr[directiveName], function (file) {
                ...
                if (file && file.type && file.type.search(getTagType(elem[0])) === 0 &&
                    ...
                    if (size &&imageUpload.isResizeSupported()) {
                       imageUpload.resize(file, size.width, size.height, size.quality).then(
                            function (f) {
                                constructDataUrl(f);
                            }, function (e) {
                                throw e;
        ...
        return {
            ...
            link: function (scope, elem, attr) {
                linkFileDirective(Upload, $timeout, scope, elem, attr, 'ngfSrc',
                   imageUpload.attrGetter('ngfResize', attr, scope), false);
            }
        };
    }]);
        ...
        return {
            ...
            link: function (scope, elem, attr) {
                linkFileDirective(Upload, $timeout, scope, elem, attr, 'ngfBackground',
                   imageUpload.attrGetter('ngfResize', attr, scope), true);
            }
        };
    }]);
    ...
    ngFileUpload.directive('ngfThumbnail', ['Upload', '$timeout', function (Upload, $timeout) {
        return {
            restrict: 'AE',
            link: function (scope, elem, attr) {
                var size =imageUpload.attrGetter('ngfSize', attr, scope);
                linkFileDirective(Upload, $timeout, scope, elem, attr, 'ngfThumbnail', size,
                   imageUpload.attrGetter('ngfAsBackground', attr, scope));
            }
        };
    }]);
...
(function () {
    ngFileUpload.directive('ngfDrop', ['$parse', '$timeout', '$location','imageUpload', '$http', '$q',
    ...
    ngFileUpload.directive('ngfDropAvailable', ['$parse', '$timeout','imageUpload', function ($parse, $timeout, Upload) {
